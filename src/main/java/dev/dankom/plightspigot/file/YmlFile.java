package dev.dankom.plightspigot.file;
...
public class YmlFile {
    ...
    public YmlFile(String fileName, PlightPlugin plugin) {
    ...
    public YmlSection createSection(String path) {
        return new YmlSection(this, path);
    }

    public static YmlFile create(String name, PlightPlugin plugin) {
        YmlFile file = new YmlFile(name, plugin);
        return file;
    }
}
